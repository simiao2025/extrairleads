			...
			<div className="max-w-7xl mx-auto space-y-6">
					...
					<div className="flex items-center gap-4">
						<Link href="/">
							<Button
								variant="ghost"
								size="icon-sm"
								className="text-zinc-400 hover:text-white pointer-events-none"
							>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-full">
					{Array.from({ length: 8 }).map((_, i) => (
						<div
							key={i}
							className="flex flex-col justify-between rounded-2xl bg-zinc-900/20 border border-zinc-800/30 p-5 space-y-4"
						>
