			...
			<div className="mx-auto max-w-[1400px] space-y-10 px-4 py-10 md:px-8 relative z-10">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mt-8">
					{[1, 2, 3, 4].map((i) => (
						<div
							key={i}
							className="h-28 rounded-2xl bg-zinc-900/40 border border-zinc-800/50 p-5 animate-pulse flex flex-col justify-end"
						>
				...
				<div className="mt-12 space-y-5">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
						{[1, 2, 3, 4].map((i) => (
							<div
								key={i}
								className="h-[60vh] bg-zinc-900/30 rounded-2xl border border-zinc-800/40 p-4"
							>
