...
import { db } from "@/db";
import { appointments, campaignConfigs, chatHistory, leads, users } from "@/db/schema";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const evolutionUrl =
      process.env.EVOLUTION_API_URL || "https://evolution-api.brasilonthebox.shop";
        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              dateStr: {
                type: "string",
                description: "Data e hora do agendamento (Exemplo: '2026-05-20 14:00').",
              },
              notes: {
                type: "string",
                description: "Observações ou detalhes adicionais sobre o agendamento.",
              },
            },
            required: ["dateStr"],
          },
        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              text_to_speak: {
                type: "string",
                description: "O texto exato que será convertido em voz e enviado ao cliente.",
              },
            },
