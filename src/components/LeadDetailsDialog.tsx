					...
					children ? (
						...
						>
							...
							<div className="relative z-10 flex flex-col items-center w-full">
								{lead.imageUrl ? (
									...
									<img
										src={lead.imageUrl}
										alt={lead.name}
										className="w-14 h-14 rounded-full object-cover border-2 border-white/10 group-hover:border-emerald-500/40 transition-colors shadow-lg mb-3"
									/>
								) : (
							...
							<div className="mt-5 w-full flex items-center justify-between relative z-10 border-t border-white/[0.05] pt-3">
								...
								{lead.phone && (
									<div className="flex items-center justify-center w-7 h-7 rounded-full bg-white/[0.02] border border-white/[0.05] group-hover:bg-emerald-500/20 group-hover:border-emerald-500/30 transition-all duration-300">
